            ...
            <div className="flex items-center justify-between h-20">
              ...
              <div className="flex-shrink-0 flex items-center gap-2 group cursor-pointer">
                <Link to="/" className="flex items-center gap-3 relative">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-turquoise-light tracking-[0.3em] uppercase font-bold">
                      İlim Şehri
                    </span>
                  </div>
                </Link>
              ...
              <div className="hidden md:flex items-center space-x-1">
                ...
                <button 
                  ...
                  className={`p-2 rounded-full transition-all border ${isSearchOpen ? 'bg-gold text-turquoise-dark border-gold' : 'text-gold hover:bg-gold/10 border-transparent hover:border-gold/30'}`}
                  title="Arama Yap"
                >
            ...
            <div className="absolute top-full left-0 w-full bg-turquoise-dark border-b border-gold/20 p-6 shadow-2xl animate-fade-in z-40">
              <div className="max-w-3xl mx-auto flex items-center gap-4 border-b-2 border-gold/30 pb-2">
                ...
                <input 
                  type="text" 
                  autoFocus
                  placeholder="İlim şehrinde ara..." 
                  className="w-full bg-transparent text-2xl text-sand placeholder-slate-300 border-none outline-none font-sans"
                  value={searchQuery}
...
const MobileNavLink = ({ to, label, onClick }) => (
  <Link
    to={to}
    onClick={onClick}
    className="text-slate-200 hover:text-gold hover:bg-gold/10 block px-3 py-2 rounded-lg text-base font-medium font-sans"
  >
    {label}
  </Link>
);

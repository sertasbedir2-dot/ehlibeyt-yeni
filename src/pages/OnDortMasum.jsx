...
// YENİ: Az önce oluşturduğumuz veri dosyasını çağırıyoruz
import { MASUM_DEEP_DATA } from '../data/masumDeepData';

// --- GÖRSEL KATMAN (p5.js - Koyu Tema) ---
...
export default function OnDortMasum() {
  ...
  const [activeTab, setActiveTab] = useState('ontology'); // Sekmeler için state

  const handleCardClick = (id) => {
    setSelectedId(id);
    setActiveTab('ontology'); // Kart açılınca ilk sekme Ontoloji olsun
  };
                                ...
                                {activeTab === 'politics' && (
                                    <div className="space-y-4 animate-fade-in">
                                        ...
                                        <div className="space-y-2">
                                            {masum.politics.events.map((ev, i) => (

...
import { sorularData } from '../data/sorularData'; 
...
export default function SoruCevap() {
  ...
  const handleIdrak = (id, e) => {
    ...
    if (awardedIds.includes(id)) return; 
    ...
    <div className="space-y-8 animate-fade-in pb-20 font-sans">
      ...
      <div className="max-w-4xl mx-auto mt-16 bg-gradient-to-br from-[#09303a] to-[#04151a] border border-[#C5A059]/30 p-8 md:p-10 rounded-3xl text-center shadow-2xl relative overflow-hidden group">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          {/* LİNKLER BURADA DÜZELTİLDİ */}
          <a href="https://wa.me/905553137021" target="_blank" rel="noopener noreferrer" className="bg-green-600 hover:bg-green-500 text-white px-8 py-3 rounded-xl font-bold transition-colors shadow-lg flex items-center justify-center gap-2">
             WhatsApp'tan Sor
          </a>
          <a href="https://t.me/dunyaehlibeyt" target="_blank" rel="noopener noreferrer" className="bg-blue-500 hover:bg-blue-400 text-white px-8 py-3 rounded-xl font-bold transition-colors shadow-lg flex items-center justify-center gap-2">
